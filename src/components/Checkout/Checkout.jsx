    ...
    return (
        <div >
            ...
            <div className="checkout appear" hidden={context.cart.length === 0}>
                ...
                <div className="checkout__title">Dirección de facturación</div>
                ...
                <Link to="/orders" className={`btn--big ${((context.cart.length > 0) && (buyer.name !== '' && buyer.phone !== '' && buyer.email !== '')) ? '' : 'disabled'}`} onClick={createOrder}> REALIZAR ORDEN </Link>
            </div>
        </div>
